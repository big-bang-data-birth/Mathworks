...
%  data_ps_spec/PeakAmp6
%  data_ps_spec/PeakAmp7
...
% Auto-generated by MATLAB on 15-Oct-2025 01:13:14
...
while hasdata(outputEnsemble)
    ...
    try
        ...
        [peakAmp,peakFreq] = findpeaks(ps,w/factor,'MinPeakHeight',-Inf, ...
            'MinPeakProminence',0,'MinPeakDistance',0.001,'SortStr','descend','NPeaks',7);
        peakAmp = [peakAmp(:); NaN(7-numel(peakAmp),1)];
        peakFreq = [peakFreq(:); NaN(7-numel(peakFreq),1)];
        ...
        featureValues = [PeakAmp3,PeakAmp4,PeakAmp5,PeakAmp6,PeakAmp7,BandPower];

        % Store computed features in a table.
        featureNames = {'PeakAmp3','PeakAmp4','PeakAmp5','PeakAmp6','PeakAmp7','BandPower'};
...
selectedFeatureNames = ["data_ps_spec/PeakAmp3","data_ps_spec/PeakAmp4","data_ps_spec/PeakAmp5","data_ps_spec/PeakAmp6","data_ps_spec/PeakAmp7","data_ps_spec/BandPower"];
